...
export GRADLE_HOME=/Users/oshima_takako/Applications/gradle-1.7-rc-1      
export PATH=$GRADLE_HOME/bin:$PATH   
export GRADLE_OPTS=-Dorg.gradle.daemon=true

alias glog="git log --color --decorate --graph --oneline"
alias gdiff="git diff --color"
alias backsql="mysqldump -A -u root -prootpasswd --opt > /Users/oshima_takako/backbox/mysql/db_backup_`date +%Y%m%d-%H%M%S`.sql"
